  ...
  return (
    <section className="relative flex flex-col bg-transparent backdrop-blur-0 min-h-screen overflow-hidden">
      ...
      {paintings.map(({ id, image, title, description, artist }) => (
        <div
          key={id}
          className="painting-panel w-full h-[700px] flex items-center justify-center px-8 lg:px-16 py-16"
        >
          <div className="flex border p-2 flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-7xl w-full">
            <div className="flex border w-full p-8">
              {/* Artwork Container */}
              <div className="relative flex-1 flex justify-center items-center">
                <div className="relative group inline-block">
                  ...
                  <img
                    src={image}
                    alt={title}
                    className="relative max-h-[50vh] w-auto object-contain rounded-xl shadow-2xl 
